...
appointment = Table('appointment', post_meta,
    ...
    Column('updated', DateTime, nullable=False, default=ColumnDefault(datetime.datetime(2014, 6, 11, 14, 35, 45, 4422))),
    Column('agreement', DateTime, nullable=False, default=ColumnDefault(datetime.datetime(2014, 6, 11, 14, 35, 45, 4464))),
...
profile = Table('profile', post_meta,
    ...
    Column('updated', DateTime, nullable=False, default=ColumnDefault(datetime.datetime(2014, 6, 11, 20, 35, 44, 995773))),
    Column('created', DateTime, nullable=False, default=ColumnDefault(datetime.datetime(2014, 6, 11, 20, 35, 44, 995817))),
)
...
proposal = Table('proposal', post_meta,
    ...
    Column('prop_created', DateTime, nullable=False, default=ColumnDefault(datetime.datetime(2014, 6, 11, 20, 35, 44, 999201))),
    Column('prop_updated', DateTime, nullable=False, default=ColumnDefault(datetime.datetime(2014, 6, 11, 20, 35, 44, 999237))),
...
review = Table('review', post_meta,
    ...
    Column('rev_updated', DateTime, nullable=False, default=ColumnDefault(datetime.datetime(2014, 6, 11, 20, 35, 45, 16683))),
