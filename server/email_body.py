...
def email_body_verify_account(verify_email_url):
	...
	msg = msg + '<font style="font-family:Helvetica Neue;color:#555555;font-size:10px;"> <a href="mailto:thegang@insprite.co" style="color:#29abe1">Contact Us</a> | Sent by <a href="https://insprite.co" style="color:#29abe1">Insprite.co</a>, California, USA. | <a href="#" style="color:#29abe1">Unsubscribe</a></font>'
	msg = msg + '</td></tr></table>'
...
def email_body_new_proposal_notification_to_seller(proposal, buyer_name, buyer_profile_id):
	...
	msg = msg + '\n\t\t\t\t<a href="https://www.insprite.co"><img src="http://ryanfbaker.com/insprite/inspriteLogoA.png" border="0" alt="Insprite" align="center" width="200px" height="55px" />'
	msg = msg + '\n\t\t\t\t</a>'
	msg = msg + '\n\t\t\t</td></tr>'
	msg = msg + '\n\t\t</tbody>'
	msg = msg + '\n\t</table>'
	...
	msg = msg + '\n\t\t<tr><td style="background-color: #ffffff; border-top: 0px solid #333333; border-bottom: 10px solid #FFFFFF;padding-top:10px;padding-left:75px;padding-bottom:200px" align="left" valign="top">'
	...
	msg = msg + '\n\t<table style="border-left: 2px solid #e6e6e6; border-right: 2px solid #e6e6e6;" cellspacing="0" cellpadding="0" width="600">'
	msg = msg + '\n\t\t<tr><td style="background-color: #ffffff; border-top: 0px solid #333333; border-bottom: 10px solid #FFFFFF;padding-top:0px;padding-left:75px" align="left" valign="top">'
	msg = msg + '\n\t\t\t<img style="padding-right: 6px" src="http://maps.googleapis.com/maps/api/staticmap?center='+proposal.prop_place+'&zoom=13&size=450x450&markers=size:large%8Ccolor:0xFFFF00%7Clabel:Insprite%7CT'+proposal.prop_place+'">'
	msg = msg + '\n\t\t</td></tr>'
	msg = msg + '\n\t</table>'
...
def email_body_meeting_rejected_notification_to_seller(proposal, buyer_name, buyer_prof_id):
	...
	msg = msg + '\t\t\t\t\tYou did not accept a proposal from <a href=\"https://127.0.0.1:5000/profile?hero=\"' + buyer_prof_id + ' style="color:#29abe1">' + buyer_name + '</a>.<br><br>'
	msg = msg + '\t\t\t\t\tMessage <a href="#" style="color:#29abe1">' + buyer_name + '</a> to see if you can work our a new date and time.'
	msg = msg + '\t\t\t\t</font><br><br>'
	msg = msg + '\t\t\t</td></tr>'
	msg = msg + '\t\t</table>'
