...
def email_body_appointment_confirmation_for_buyer(meeting, buyer_profile, sellr_profile):
...
def email_body_cancellation_from_seller_to_seller(buyer_profile):
	...
	msg = header + '<table cellspacing="0" width="80%" align="center">\n<tr>\n<td style="padding-top:50px;padding-bottom:10px" align="left" valign="top">\n<font style="font-family:Helvetica Neue,Arial,sans-serif;color:#555;font-size:14px;line-height:14px">\nThis is just a heads up - You canceled your lesson with <a href="' + site_url + '/profile?hero='+ buyer_profile.prof_id + '" style="color:#e75f63">' + buyer_profile.prof_name + '</a>. Please get in touch with them if you would like to reschedule.<br><br>\n</font>\n</td>\n</tr>\n</table>' + footer
