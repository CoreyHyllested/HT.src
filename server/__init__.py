...
#	sc_server.use_x_sendfile = sc_server.config.get('USE_SENDFILE', False)	mod_xsendfile not installed on AWS/httpd
	...
	css_referral =	Bundle('scss/referral.scss', filters='pyscss', output='css/referral.css')
	...
	from routes import authentication, everyone, users, api
	from routes import admin, errors, meta, testing
	from routes import sc_admin
	...
	sc_server.register_blueprint(sc_admin)
