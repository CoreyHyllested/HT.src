...
def upgrade():
	...
	# CAH -- had to comment this out to upgrade production (not sure if I did this before).
	# Production clearly shows this does exist.
...
#	CAH.  Also dropping this, just in case, matching above... but I likely do not want this removed.
