...
migration_file = MIGRATE_REPO + '/versions/%03d_migration.py' % (api.db_version(DATABASE_URI, MIGRATE_REPO) + 1)
print 'next database version would be', migration_file
...
print 'New migration saved as ' + migration_file
